...
namespace App\Services\SendingProcess\Telecom\Encoder;
...
class GsmEncoder
{
    ...
    public static function pack7bit($data)
    {
        ...
        for ($i = 0; $i < $l; $i++) {
            ...
            if ($offset > 7) {
                ...
                // https://www.php.net/manual/en/migration70.incompatible.php#migration70.incompatible.integers.negative-bitshift
                $bitShiftNum = 7 - ($offset - 8);
                $currentByte = $septet = $bitShiftNum > 0 ? $septet >> $bitShiftNum : 0;
                // update offset
    ...
    public static function utf8_to_gsm0338_transliterate($string)
    {
        $dict = array(
            '@' => '#', '£' => '#', '$' => '$', '¥' => 'Y', 'è' => 'e', 'é' => 'e', 'ù' => 'u', 'ì' => 'i', 'ò' => 'o',
            'Ç' => 'S', 'Ø' => '0', 'ø' => 'o', 'Å' => 'A', 'å' => 'a',
            'Δ' => 'D', '_' => '.', 'Φ' => 'F', 'Γ' => 'G', 'Λ' => 'L', 'Ω' => 'W', 'Π' => 'P', 'Ψ' => 'Y', 'Σ' => 'S',
            'Θ' => 'Q', 'Ξ' => 'C', 'Æ' => 'A', 'æ' => 'a', 'ß' => 'S', 'É' => 'E',
            '¤' => "\x24", # "$" in ASCII
            '¡' => '!',
            'Ä' => 'A', 'Ö' => 'O', 'Ñ' => 'N', 'Ü' => 'U', '§' => '#',
            '¿' => '?',
