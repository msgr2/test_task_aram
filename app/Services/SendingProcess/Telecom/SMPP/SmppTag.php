...
class SmppTag
{
    ...
    const DLR_WITH_MCCMNC = 0x1421;
    const MCCMNC = 0x1402; # Nexmo
    const MCCMNC2 = 0x1416; # Avys
    const PRICE = 0x1422;
    const BALANCE = 0x1423;
     ...
     */
    public function __construct(public $id, public $value, public $length = null, public $type = 'a*')
    {
    }
