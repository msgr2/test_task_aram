 ...
 * @link       http://pear.php.net/package/Net_SMPP
 */
class DeliverSm extends Command
{
    /**
     ...
     * @var  int
     */
    var $source_addr_ton = SERVER_SMPP_TON_UNK;
     ...
     * @var  int
     */
    var $source_addr_npi = SERVER_SMPP_NPI_UNK;
     ...
     * @var  int
     */
    var $dest_addr_ton = SERVER_SMPP_TON_UNK;
     ...
     * @var  int
     */
    var $dest_addr_npi = SERVER_SMPP_NPI_UNK;
     ...
     * See the SERVER_SMPP_MSGMODE_*, SERVER_SMPP_MSGTYPE_*, and SERVER_SMPP_GSMFEAT_*
     ...
     * @var  int
     */
    var $esm_class = SERVER_SMPP_MSGMODE_DEFAULT;
     ...
     * @var  int
     */
    var $data_coding = SERVER_SMPP_ENCODING_DEFAULT;
